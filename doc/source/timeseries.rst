...
.. csv-table::
    ...
    QuarterEnd, "Q", "calendar quarter end, optionally anchored year on a month"
    QuarterBegin, "QS", "calendar quarter begin, optionally anchored year on a month"
    BQuarterEnd, "BQ", "business quarter end, optionally anchored year on a month"
    BQuarterBegin, "BQS", "business quarter begin, optionally anchored year on a month"
    FY5253Quarter, "", "retail (aka 52-53 week) quarter"
    YearEnd, "A, Y", "calendar year end, optionally anchored year on a month"
    YearBegin, "AS, YS", "calendar year begin, optionally anchored year on a month"
    BYearEnd, "BA, BY", "business year end, optionally anchored year on a month"
    BYearBegin, "BAS, BYS", "business year begin, optionally anchored year on a month"
